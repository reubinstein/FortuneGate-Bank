  ...
  return (
    <section className="auth-form">
         ...
         <Link href="/" className=" cursor-pointer  flex items-center gap-1">
            <Image src="/icons/logo.svg" width={34} height={34} alt="FortuneGate Logo" />
            <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">FortuneGate</h1>
         </Link>  
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        {type==='sign-up' &&(
          <>
            ...
            label="State" placeholder="Example:Tanzania"
            />
            <CustomInput
            control={form.control} name="postalCode"
            label="Postal Code" placeholder="Example:11011"
            />
            </div>
            <div className="flex gap-4">
            <CustomInput
            ...
            label="SSN" placeholder="Example:12345"
            />
            </div>
          </>
        )}
